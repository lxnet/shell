#!/usr/bin/env bash
# 
# timecapsule alike script based on laurent's work.
#
# campai 2014
# execute : ./sync2 /source/dir /destination/dir
# be sure to create a file /destination/dir/backup.marker
# 
# TODO : - Build in mail function
#	   : - Better error handling
# 	   : - Make it readable for Roland (more comments)
...
# We can use generic linux, windows sygwin env and MacOSX
# -----------------------------------------------------------------------------

fn_parse_date() {
	# Converts YYYY-MM-DD-HHMMSS to YYYY-MM-DD HH:MM:SS and then to Unix Epoch per selected OS.
	case "$OSTYPE" in
